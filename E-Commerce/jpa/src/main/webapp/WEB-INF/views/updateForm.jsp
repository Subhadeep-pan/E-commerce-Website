	...
	<div class="container">
		<div class="navigation">
			<ul>
				...
				<li><a href="viewitem"> <span class="icon"><i
							class="fa fa-home" aria-hidden="true"></i></span> <span class="title">Home</span>
				</a></li>

				<li><a href="addform"> <span class="icon"><i
							class="fa fa-id-card" aria-hidden="true"></i></span> <span class="title">Add
							Product</span>
				</a></li>
				<li><a href="#"> <span class="icon"><i
				...
				<li><a href="login.jsp"> <span class="icon"><i
				...
				<div class="recentorders">
					...
					<div>
						...
						<form action="/update" method="post" enctype="multipart/form-data">
							...
							<br> <label for="lname">ProductCatagory</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							...
							<div style="display: flex; align-items: center;">
								<label for="fileInput" style="margin-right: 3.5rem;">Select
									File:</label> <input type="file" name="file" accept="image/, video/"
