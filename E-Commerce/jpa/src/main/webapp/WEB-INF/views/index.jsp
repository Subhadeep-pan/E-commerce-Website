...
-->
    ...
    <header class="header-area header-sticky">
                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                         <li class="scroll-to-section"><a href="/" class="active">Home</a></li>
        					...
        					<a class="dropdown-item" href="/access">Accessories</a>
                                </ul>
      ...
      if (str != null) {
      %>
         <li><a href="/logout">logout</a></li></a></li>
       <% } 
else { %>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-content">
                        ...
                        <span>Step into a world of style designed for everyone. Whether you’re hunting for everyday essentials, festive fits, or bold statement pieces, we’ve got your wardrobe dreams covered.

For Men: Sleek formals, relaxed casuals, and street-smart trends – because style is never just one-size-fits-all.

For Women: Elegant dresses, comfy loungewear, and power outfits – all made to help you own every moment.

For Kids: Adorable, durable, and playful fits – because their adventures deserve the best.

Discover outfits that aren’t just clothes – they’re your vibe.
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-6">
                            <ul>
                                <li>Store Location:<br><span>712122 ,kolkata, West bengal</span></li>
                                <li>Phone:<br><span>010-020-0340</span></li>
                                <li>Office Location:<br><span>SD Mall</span></li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        ...
                        <ul>
                            <li><a href="#">712122 ,kolkata, West bengal</a></li>
