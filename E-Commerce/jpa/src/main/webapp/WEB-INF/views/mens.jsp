				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<ul class="nav">
							...
							<li class="submenu"><a href="javascript:;">Category</a>
								<ul>
		...
		<div class="row">
			...
			<div class="col-md-4 mb-4">
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						<img src="<%=prod.getFilePath()%>" width="200" height="150"
							alt="Image" />
						...
						%>
						<a
							href="/pdetails?prodid=<%=prod.getId()%>&price=<%=prod.getPrice()%>&email=<%=str%>"
