	...
	<div class="container">
		<div class="navigation">
			<ul>
				...
				<li><a href="/viewUser"> <span class="icon"><i
							class="fa fa-user" aria-hidden="true"></i></span> <span class="title">View
							User</span>
				</a></li>
				<li><a href="/viewOrder"> <span class="icon"><i
							class="fa fa-cogs" aria-hidden="true"></i></span> <span class="title">View
							Order</span>
				</a></li>

				<li><a href="app"> <span class="icon"><i
							class="fa fa-cogs" aria-hidden="true"></i></span> <span class="title">View
							Feedback</span>
				</a></li>

				<li><a href="/log"> <span class="icon"><i
						...
						<tbody>
							<tr>
								...
								<td style="text-align: center;">
									...
									%> <img src="<%=filePath%>" width="110" height="70" /> <%
 } else {
 %> N/A <%
 }
 %>
