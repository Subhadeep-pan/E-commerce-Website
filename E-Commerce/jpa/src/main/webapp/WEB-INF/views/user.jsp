			...
			<div class="cardbox">
				...
				<div class="card" style="box-shadow: 0.05px 0px 1.1px black;">
					<div>
						...
						<div class="cardname">Poducts</div>
						<div class="numbers"></div>
					</div>
					<div class="iconbox">
			...
			<div class="details">
				<div class="recentorders" style="width: 1000px;">
					<div class="cardheader">
						<div>
							<i class="fa-solid fa-user" style="font-size: 21.5px;"></i>&nbsp;
							<h2 style="display: inline-block;">User Details</h2>
						</div>
					...
					<table>
						...
						<tbody>
							<tr>
							<% 
								List<User> user = (List<User>)request.getAttribute("userDetails");
								if(user != null && !user.isEmpty()){
									for(User u: user){
										if(!u.getName().equals("Admin")){
							%>
							<td style="text-align: center;"><%= u.getName() %></td>
							<td style="text-align: center;"><%= u.getEmail() %></td>
							<td style="text-align: center;"><%= u.getPhno() %></td>
							</tr>
							<% 
										}
									}
							...
							%>
							<td colspan="3" style="text-align:center;"><h4 style="color: black; padding: 0.5rem 0rem; color: red;">No user to display!</h4></td>
							<% } %>
						</tbody>
					</table>
				</div>
